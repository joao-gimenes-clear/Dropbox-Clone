class DropBoxController {
  ...
  connectFirebase(){
    const firebaseConfig = {
      apiKey: "AIzaSyCmgRFjHDfuk_NDiSQvKyyH9o37ejvKv0k",
      authDomain: "dropbox-clone-15307.firebaseapp.com",
      databaseURL: "https://dropbox-clone-15307-default-rtdb.firebaseio.com",
      projectId: "dropbox-clone-15307",
      storageBucket: "dropbox-clone-15307.appspot.com",
      messagingSenderId: "520164187684",
      appId: "1:520164187684:web:08088cdef62a1f672e82b1"
    };
      ...
      let key = li.dataset.key;
        ...
        promises.push(new Promise((resolve, reject)=>{
          ...
          if (file.mimetype === 'folder'){
            ...
            this.removeFile(this.currentFolder.join('/'), file.ee).then(()=>{
  ...
  removeFile(ref, originalFilename) {

    let fileRef = firebase.storage().ref(ref).child(originalFilename);
  ...
  initEvents() {
    ...
    this.btnRename.addEventListener("click", (e) => {
      ...
      let originalFilename = prompt("Renomar o arquivo:", file.originalFilename);
